...
public interface EpisodeController {
    ...
    @Operation(summary = "회차 조회 API", description = "회차의 ID를 통해 특정 회차를 조회합니다." +
    ...
    @Operation(summary = "회차 내용 페이지 조회 API", description = "특정 회차의 내용을 페이지 단위로 조회합니다." +
    ...
    @Operation(summary = "회차 수정 API", description = "회차의 ID를 통해 특정 회차를 수정합니다." +
            "기본적으로 회차 생성 API와 유사하며 어느 회차를 수정할 지 PathVariable로 회차 id를 받는 점이 추가되었습니다." +
