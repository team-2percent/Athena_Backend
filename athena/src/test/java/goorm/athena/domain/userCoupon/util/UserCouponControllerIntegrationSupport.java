...
import goorm.athena.domain.userCoupon.controller.UserCouponController;
...
public abstract class UserCouponControllerIntegrationSupport extends IntegrationControllerTestSupport {
    @Autowired
